...
EDITABLE_ENV_VARS = {
    ...
    "SKYVERN_LLM_XIAOMI_MIMO_API_KEY",
    "SKYVERN_LLM_XIAOMI_MIMO_MODEL",
    "SKYVERN_LLM_XIAOMI_MIMO_BASE_URL",
    "SKYVERN_LLM_XIAOMI_MIMO_RPM_LIMIT",
    "SKYVERN_LLM_DEEPSEEK_API_KEY",
    "SKYVERN_LLM_DEEPSEEK_MODEL",
    "SKYVERN_LLM_DEEPSEEK_BASE_URL",
    "SKYVERN_LLM_DEEPSEEK_RPM_LIMIT",
}
