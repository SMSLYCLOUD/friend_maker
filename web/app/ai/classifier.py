...
class ProfileClassifier:
    ...
    async def classify(self, profile_data: Dict[str, Any], image_base64: Optional[str] = None) -> Dict[str, Any]:
        prompt = f"""
...
{"(I have attached a screenshot of the profile for visual analysis.)" if image_base64 else ""}
